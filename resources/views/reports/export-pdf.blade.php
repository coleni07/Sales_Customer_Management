...
<body>
    ...
    @if ($report === 'all' && isset($overview))
        ...
        <table>
            ...
            <tr>
                <td>Total Sales</td>
                <td>₱{{ number_format($overview['totalSales']['value'], 2) }}</td>
            </tr>
            <tr>
                <td>Monthly Target</td>
                <td>₱{{ number_format($overview['totalSales']['target'], 2) }}</td>
            </tr>
            <tr>
                <td>Target Achievement</td>
                <td>{{ $overview['totalSales']['percent'] }}%</td>
            </tr>
            <tr>
                <td>Forecast</td>
                <td>₱{{ number_format($overview['forecast']['value'], 2) }}</td>
            </tr>
        </table>
    @endif
